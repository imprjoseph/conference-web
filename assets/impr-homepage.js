...
function enhanceHomepageLabels() {
    const sectionMap = [
        { keyword: "最新消息", desc: "掌握活動最新公告與重要提醒" },
        { keyword: "會議介紹", desc: "了解本次活動目標、議題方向與參與價值" },
        { keyword: "講師介紹", desc: "邀集專業講者分享產業觀點與實務經驗" },
        { keyword: "會議議程", desc: "查看完整時程安排與各場次重點" },
        { keyword: "線上報名", desc: "填寫報名資料，完成活動參與登記" },
        { keyword: "交通資訊", desc: "活動地點、交通方式與現場資訊" },
        { keyword: "下載專區", desc: "下載會議簡章、講義與相關文件" },
        { keyword: "常見問題", desc: "快速查詢活動報名與參與相關問題" }
    ];

    document.querySelectorAll(".section-eyebrow").forEach(function (eyebrow) {
        eyebrow.remove();
    });
